...
class Secoder {
	...
	public static $fontSize = 35;     // 验证码字体大小(px)
	...
	public static function entry() {
		...
		$fft_array = array('fonts/elephant.ttf','fonts/arial.ttf','fonts/hyq1gjm.ttf');
...
// useage
//Secoder::$useNoise = true;  // 要更安全的话改成true
//Secoder::$useCurve = true;
//Secoder::entry();

// 验证验证码
/*
if (!YL_Security_Secoder::check(@$_POST['randcode'])) {
	print 'error secode';
}
*/
?>