...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class="click"><a href="<?php echo site_url('admin/teacher/add') ?>"><span><img src="<?php echo base_url('source/images/t01.png') ?>" /></span>添加</a></li>
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(){
			var editUrl = "<?php echo base_url('admin/teacher/edit') ?>";
            var delUrl = "<?php echo base_url('admin/teacher/del') ?>";
