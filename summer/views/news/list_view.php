...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class="click"><a href="<?php echo site_url('admin/news/add') ?>"><span><img src="<?php echo base_url('source/images/t01.png') ?>" /></span>添加</a></li>
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(){
			var getUrl = "<?php echo site_url('admin/news/jsoncategorylist') ?>";
			var editUrl = "<?php echo base_url('admin/news/edit') ?>";
            var delUrl = "<?php echo base_url('admin/news/del') ?>";
            ...
            for(var i = 0; i < dataLength; i++){
                ...
                bindStr += '<td>'+data[i]['news_id']+'</td>';
                bindStr += '<td>'+data[i]['category_name']+'</td>';
                bindStr += '<td>'+data[i]['title']+'</td>';
                bindStr += '<td>'+new Date(parseInt(data[i]['add_time']) * 1000).toLocaleString().substr(0,10)+'</td>';
                bindStr += '<td><a href="'+ editUrl + '/' +data[i]['news_id'] + '" >编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="'+ delUrl + '/' +data[i]['news_id'] + '">删除</a></td>';
                bindStr += '</tr>'
            }
