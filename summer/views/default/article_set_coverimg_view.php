...
<div class="admin-content" style="min-height:1400px;">
    ...
    <div class="am-g" >
        <form id="articleForm" method="post" action="<?=site_url('c=post&m=set_coverimg')?>" class="am-form am-form-horizontal">
            <div class="am-form-group">
              ...
              <div  class="am-u-sm-9">
                ...
                <div>  
                  <img src="<?=base_url(set_value('coverimg_path', ''))?>" style="width:100px" id="upload-img-view" />
                </div>
                <input type="hidden" name="coverimg_path" id="cover-img-src-input" value="<?=set_value('coverimg_path', '')?>" /> 
