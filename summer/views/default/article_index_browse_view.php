      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
            <a class="am-btn am-btn-default"  href="<?php echo site_url('d=article&c=y&m=create') ?>"><span class="am-icon-plus"></span> 新增</a>
        ...
        <form class="am-form">
          ...
          <?php foreach($page['data_list'] as $article){ ?>
            <tr>
              ...
              <td style="width:40%"><a target="blank" href=""><?php echo $article['title'] ?></a></td>
              ...
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    ...
                    <?php }else{ ?>
                      <a href="<?php echo site_url('c=post&m=set_coverimg&id='.$article['id']) ?>" class="am-btn am-btn-default am-btn-xs am-text-danger"><span class="am-icon-trash-o"></span>添加封面</a>
                    <?php } ?> 
