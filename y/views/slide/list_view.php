...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class="click"><a href="<?php echo site_url('admin/slide/add') ?>"><span><img src="<?php echo base_url('source/images/t01.png') ?>" /></span>添加</a></li>
    ...
    <table class="tablelist" >
        ...
        <tbody id="bind-data">
        <?php foreach($slidesList as $v){ ?>
            <tr>
            <td><input name="" type="checkbox" value="" /></td>
            <td><?php echo $v['id'] ?></td>
            <td style="width:200px;"><img style="width:200px;" src="<?php echo base_url($v['value']['picSrc']) ?>" /></td>
            <td><?php echo $v['value']['name'] ?></td> 
            <td>
            <a href="<?php echo site_url('admin/slide/edit/'.$v['id']) ?>" class="tablelink">编辑</a>     
            <a href="<?php echo site_url('admin/slide/del/'.$v['id']) ?>" class="tablelink"> 删除</a></td>
            </tr> 
        <?php } ?>
        </tbody>
    </table>
