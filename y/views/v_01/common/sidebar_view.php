            ...
            <ul class="am-list admin-sidebar-list">
                ...
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                        <li><a href="<?php echo site_url('d=article&c=y&m=index') ?>" class="am-cf"><span class="am-icon-check"></span> 文章列表<!-- <span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span> --></a></li>
                        <li><a href="<?php echo site_url('d=article&c=y&m=create') ?>"><span class="am-icon-puzzle-piece"></span> 发布文章</a></li>
                 ...
                 <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="photo-manage">
                        <li><a href="<?php echo site_url('d=article&c=photo&m=index&category_id=8') ?>" class="am-cf"><span class="am-icon-check"></span> 图片新闻<!-- <span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span> --></a></li>
                        <li><a href="<?php echo site_url('d=article&c=photo&m=index&category_id=7') ?>"><span class="am-icon-puzzle-piece"></span> 光影交院</a></li>
                       <!--  <li><a href="admin-404.html"><span class="am-icon-bug"></span> 404</a></li> -->
                    </ul>
                </li>
                 <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="video-manage">
                        <li><a href="<?php echo site_url('d=article&c=video&m=index') ?>" class="am-cf"><span class="am-icon-check"></span> 视频列表<!-- <span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span> --></a></li>
                        <li><a href="<?php echo site_url('d=article&c=video&m=create') ?>"><span class="am-icon-puzzle-piece"></span> 添加视频</a></li>
                       <!--  <li><a href="admin-404.html"><span class="am-icon-bug"></span> 404</a></li> -->
                    </ul>
                </li>
